...
// Open sign-up ("shared link") mode
ensureColumn('events', 'access_mode', "access_mode TEXT NOT NULL DEFAULT 'per_guest'"); // per_guest | open_link
ensureColumn('events', 'ask_adults', 'ask_adults INTEGER NOT NULL DEFAULT 0');
ensureColumn('events', 'ask_kids', 'ask_kids INTEGER NOT NULL DEFAULT 0');
ensureColumn('events', 'public_visibility', "public_visibility TEXT NOT NULL DEFAULT 'none'"); // none | total | list
ensureColumn('events', 'public_token', 'public_token TEXT');
ensureColumn('guests', 'kids', 'kids INTEGER NOT NULL DEFAULT 0');
db.exec('CREATE INDEX IF NOT EXISTS idx_events_public ON events(public_token)');
